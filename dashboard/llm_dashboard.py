...
from dashboard.components.header import set_header_renderer
from dashboard.components.sidebar import set_sidebar_renderer
from dashboard.tabs import set_tabs_renderer
...
def _render_tabs() -> None:
    # -- Build model --
    try:
        cfg = json.loads(st.session_state.get("cfg_text", "")) if st.session_state.get("cfg_text", "") else DEMO_MODEL_CFG
        model = build_model(cfg)
...
set_header_renderer(_render_header)
set_sidebar_renderer(_render_sidebar)
set_tabs_renderer(_render_tabs)
